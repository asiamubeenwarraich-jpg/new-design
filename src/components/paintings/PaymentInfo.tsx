  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-1.5">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs font-semibold tracking-wide text-[#333333]">
      ...
      {/* Trust bullet points */}
      <div className="pt-1 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[11px] text-[#777777]">
        <div className="flex items-center gap-1">
          <CheckCircle2 className="w-3 h-3 text-emerald-700 shrink-0" />
          <span>Secure payment</span>
        </div>
        <div className="flex items-center gap-1">
          <Lock className="w-3 h-3 text-[#555555] shrink-0" />
