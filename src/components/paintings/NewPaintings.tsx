...
import { NEW_PAINTINGS, Painting } from '../../data/paintings.ts';

export interface NewPaintingsProps {
  paintings?: Painting[];
  onSelectPainting?: (painting: Painting) => void;
  onViewAll?: (path: string) => void;
}

export const NewPaintings: React.FC<NewPaintingsProps> = ({
  paintings = NEW_PAINTINGS,
  onSelectPainting,
  onViewAll,
}) => {
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-10 lg:px-14">
        ...
        {maxIndex > 0 && (
          <div 
            ...
            role="tablist"
            aria-label="New Paintings Carousel Pagination"
          >
